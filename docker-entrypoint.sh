...
python manage.py makemigrations identity_models.identity_models --settings=$PROJECT_SETTINGS
...
python manage.py migrate identity_models.identity_models --settings=$PROJECT_SETTINGS
